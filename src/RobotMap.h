...
public:
	...
	static Encoder* driveTrainFrontLeftEncoder;
	static Encoder* driveTrainFrontRightEncoder;
	static SpeedController* clawMotor;
	static DigitalInput* clawLeftClawLimit;
	static DigitalInput* clawLightClawLimit;
	static Encoder* clawEncoder;
	static Encoder* elevatorEncoder;
	static SpeedController* elevatorMotor;
	// END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=DECLARATIONS
	static AnalogInput* driveTrainRangeFinder;
